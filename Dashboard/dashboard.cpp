...
void drawWarehouseDetail(sf::RenderWindow& window, sf::Font& font,
                         ...
                         const int navCount, const string* labs)
{
    ...
    // Hai bảng gần đây
    auto drawList2 = [&](sf::Vector2f pos, const string& ttl) {
        sf::Text tt(font, ttl, 18); tt.setFillColor(sf::Color(25,42,60));
        tt.setPosition(pos); window.draw(tt);
    ...
    drawList2({30.f, 570.f},  "Phieu nhap gan day");
    drawList2({560.f, 570.f}, "Phieu xuat gan day");
...
void drawProfile(sf::RenderWindow& window, sf::Font& font,
                 ...
                 int navCount, const string* labs)
{
    window.clear(sf::Color(245,230,140));
    // khung
    ...
    for(int i=0;i<navCount;i++){
        ...
        sf::Text t(font, labs[i], 16); t.setFillColor(sf::Color(210,210,210));
